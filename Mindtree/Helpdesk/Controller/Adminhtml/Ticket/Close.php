...
class Close extends \Mindtree\Helpdesk\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        if ($ticket && $ticket->getId()) {
            try {
                $ticket->setStatus(\Mindtree\Helpdesk\Model\Ticket::STATUS_CLOSED);
                $ticket->save();
                ...
                $transport = $this->transportBuilder
                    ->setTemplateIdentifier($this->scopeConfig->getValue('mindtree_helpdesk/email_template/customer', $storeScope))
                    ->setTemplateOptions(
                        [
