...
class Save extends \Mindtree\Helpdesk\Controller\Ticket
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $ticket->setStatus(\Mindtree\Helpdesk\Model\Ticket::STATUS_OPENED);
            $ticket->save();
            ...
            $transport = $this->transportBuilder
                ->setTemplateIdentifier($this->scopeConfig->getValue('mindtree_helpdesk/email_template/store_owner', $storeScope))
                ->setTemplateOptions(
                    [
